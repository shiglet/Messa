namespace Messa.API.Protocol.Network.Types.Game.House
{
    ...
    public class HouseInformationsForGuild : HouseInformations
    {
        ...
        public HouseInformationsForGuild(int instanceId, bool secondHand, string ownerName, short worldX, short worldY, int mapId, ushort subAreaId, List<int> skillListIds, uint guildshareParams)
        {
