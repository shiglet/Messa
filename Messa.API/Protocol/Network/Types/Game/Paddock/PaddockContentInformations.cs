namespace Messa.API.Protocol.Network.Types.Game.Paddock
{
    ...
    public class PaddockContentInformations : PaddockInformations
    {
        ...
        public PaddockContentInformations(int paddockId, short worldX, short worldY, int mapId, ushort subAreaId, bool abandonned, List<MountInformationsForPaddock> mountsInformations)
        {
            PaddockId = paddockId;
            WorldX = worldX;
            WorldY = worldY;
