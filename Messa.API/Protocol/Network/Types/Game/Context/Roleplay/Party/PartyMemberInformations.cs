namespace Messa.API.Protocol.Network.Types.Game.Context.Roleplay.Party
{
    ...
    public class PartyMemberInformations : CharacterBaseInformations
    {
        ...
        public PartyMemberInformations(uint lifePoints, uint maxLifePoints, ushort prospecting, byte regenRate, ushort initiative, sbyte alignmentSide, short worldX, short worldY, int mapId, ushort subAreaId, PlayerStatus status, List<PartyCompanionMemberInformations> companions)
        {
