namespace Messa.API.Protocol.Network.Types.Game.Context.Roleplay.Job
{
    ...
    public class JobCrafterDirectoryEntryPlayerInfo : NetworkType
    {
        ...
        public JobCrafterDirectoryEntryPlayerInfo(ulong playerId, string playerName, sbyte alignmentSide, sbyte breed, bool sex, bool isInWorkshop, short worldX, short worldY, int mapId, ushort subAreaId, PlayerStatus status)
        {
            PlayerId = playerId;
