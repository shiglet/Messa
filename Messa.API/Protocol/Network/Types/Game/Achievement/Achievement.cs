namespace Messa.API.Protocol.Network.Types.Game.Achievement
{
    ...
    public class Achievement : NetworkType
    {
        ...
        public Achievement(ushort objectId, List<AchievementObjective> finishedObjective, List<AchievementStartedObjective> startedObjectives)
        {
            ObjectId = objectId;
