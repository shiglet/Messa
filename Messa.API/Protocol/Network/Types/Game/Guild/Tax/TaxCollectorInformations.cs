namespace Messa.API.Protocol.Network.Types.Game.Guild.Tax
{
    ...
    public class TaxCollectorInformations : NetworkType
    {
        ...
        public TaxCollectorInformations(int uniqueId, ushort firtNameId, ushort lastNameId, AdditionalTaxCollectorInformations additionalInfos, short worldX, short worldY, ushort subAreaId, byte state, EntityLook look, List<TaxCollectorComplementaryInformations> complements)
        {
            UniqueId = uniqueId;
