namespace Messa.API.Protocol.Network.Types.Game.Friend
{
    ...
    public class FriendOnlineInformations : FriendInformations
    {
        ...
        public FriendOnlineInformations(bool sex, bool havenBagShared, ulong playerId, string playerName, byte level, sbyte alignmentSide, sbyte breed, GuildInformations guildInfo, ushort moodSmileyId, PlayerStatus status)
        {
            Sex = sex;
