namespace Messa.API.Protocol.Network.Messages.Game.Inventory.Exchanges
{
    ...
    public class ExchangeGuildTaxCollectorGetMessage : NetworkMessage
    {
        ...
        public ExchangeGuildTaxCollectorGetMessage(string collectorName, short worldX, short worldY, int mapId, ushort subAreaId, string userName, ulong callerId, string callerName, double experience, ushort pods, List<ObjectItemGenericQuantity> objectsInfos)
        {
