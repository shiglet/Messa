namespace Messa.API.Protocol.Network.Messages.Game.Interactive.Zaap
{
    ...
    public class TeleportDestinationsListMessage : NetworkMessage
    {
        ...
        public TeleportDestinationsListMessage(byte teleporterType, List<int> mapIds, List<ushort> subAreaIds, List<ushort> costs, List<byte> destTeleporterType)
        {
        ...
        public override void Serialize(IDataWriter writer)
        {
            ...
            for (var destTeleporterTypeIndex = 0; destTeleporterTypeIndex < DestTeleporterType.Count; destTeleporterTypeIndex++)
            {
        ...
        public override void Deserialize(IDataReader reader)
        {
            ...
            for (var destTeleporterTypeIndex = 0; destTeleporterTypeIndex < destTeleporterTypeCount; destTeleporterTypeIndex++)
            {
