namespace Messa.API.Protocol.Network.Messages.Game.Context.Fight
{
    ...
    public class GameFightEndMessage : NetworkMessage
    {
        ...
        public GameFightEndMessage(int duration, short ageBonus, short lootShareLimitMalus, List<FightResultListEntry> results, List<NamedPartyTeamWithOutcome> namedPartyTeamsOutcomes)
        {
            Duration = duration;
            AgeBonus = ageBonus;
