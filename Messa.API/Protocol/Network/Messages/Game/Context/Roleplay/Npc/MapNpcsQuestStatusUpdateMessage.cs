namespace Messa.API.Protocol.Network.Messages.Game.Context.Roleplay.Npc
{
    ...
    public class MapNpcsQuestStatusUpdateMessage : NetworkMessage
    {
        ...
        public MapNpcsQuestStatusUpdateMessage(int mapId, List<int> npcsIdsWithQuest, List<GameRolePlayNpcQuestFlag> questFlags, List<int> npcsIdsWithoutQuest)
        {
            MapId = mapId;
