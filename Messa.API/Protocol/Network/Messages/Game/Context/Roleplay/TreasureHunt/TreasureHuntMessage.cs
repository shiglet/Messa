namespace Messa.API.Protocol.Network.Messages.Game.Context.Roleplay.TreasureHunt
{
    ...
    public class TreasureHuntMessage : NetworkMessage
    {
        ...
        public TreasureHuntMessage(byte questType, int startMapId, List<TreasureHuntStep> knownStepsList, byte totalStepCount, uint checkPointCurrent, uint checkPointTotal, int availableRetryCount, List<TreasureHuntFlag> flags)
        {
            QuestType = questType;
