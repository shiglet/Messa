namespace Messa.API.Protocol.Network.Messages.Game.Context.Roleplay
{
    ...
    public class MapComplementaryInformationsDataMessage : NetworkMessage
    {
        ...
        public MapComplementaryInformationsDataMessage(ushort subAreaId, int mapId, List<HouseInformations> houses, List<GameRolePlayActorInformations> actors, List<InteractiveElement> interactiveElements, List<StatedElement> statedElements, List<MapObstacle> obstacles, List<FightCommonInformations> fights, bool hasAggressiveMonsters, FightStartingPositions fightStartPositions)
        {
            SubAreaId = subAreaId;
            MapId = mapId;
            Houses = houses;
